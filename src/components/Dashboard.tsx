...
export default function Dashboard({ onSwitchTab, onSelectPatient }: DashboardProps) {
  const { patients, appointments, financialRecords, currentUser, inventory, updateInventoryItem } = useStore();
